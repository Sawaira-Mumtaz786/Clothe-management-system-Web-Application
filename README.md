...
A desktop application built with **Python** and **Tkinter** to help retail shop owners manage clothing inventory, track sales and purchases, handle automatic stock updates, and generate reports.
...
- **Auto Stock Update** – Real‑time stock adjustment after every sale or purchase.
...
1. **Clone the repository**  
   ...
   Install dependencies (if any – Tkinter and sqlite3 are pre‑installed)
...
Admin: admin / admin123 (or as configured in your database)

Salesman accounts are created by the Admin.
...
For any issues or questions, please open an issue in this rep
